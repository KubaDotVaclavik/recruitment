...
export namespace CandidateFullNameErrors {
  ...
  export class NonStringError extends Result<DomainError> {
    constructor() {
      super(false, DomainError.create(`FullName must be a string`));
    }
    public static create() {
  ...
  export class TooShortError extends Result<DomainError> {
    constructor(minLength: number) {
      super(
        false,
        DomainError.create(
          `Fullname is too short. Minimum length is ${minLength}`
        )
      );
    }
  ...
  export class TooLongError extends Result<DomainError> {
    constructor(maxLength: number) {
      super(
        false,
        DomainError.create(
          `Fullname is too long. Maximum length is ${maxLength}`
        )
      );
    }
